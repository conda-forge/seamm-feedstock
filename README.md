...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seamm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12738&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seamm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seamm` can be installed with:

```
conda install seamm
```

It is possible to list all of the versions of `seamm` available on your platform with:
